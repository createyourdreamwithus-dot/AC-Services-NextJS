export default function ContactMap() {
  return (
    <section className="map-container scroll-mt-24" id="Contact" >
      <div className="mx-auto px-4 sm:max-w-[640px] md:max-w-[768px] lg:max-w-[1024px] xl:max-w-[1170px] text-center">
        <h2 className="text-4xl font-semibold text-center mb-5 text-gray-800">
          Contact
        </h2>
        <div className="w-full h-auto sm:h-[450px] mb-5">
          <iframe
